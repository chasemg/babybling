...
<?php if ($kuler->getRootSkin() == 'style_4') { ?>
	<?php include(DIR_TEMPLATE . Kuler::getInstance()->getTheme() . '/template/common/_footer_style_4.tpl'); ?>
<?php } else{ ?>
	<?php include(DIR_TEMPLATE . Kuler::getInstance()->getTheme() . '/template/common/_footer.tpl'); ?>
<?php } ?>
<?php
