...
{
// HTTP
define('HTTP_SERVER', 'http://'.$_SERVER['HTTP_HOST'].'/~babyblingbows/');

// HTTPS
define('HTTPS_SERVER', 'http://'.$_SERVER['HTTP_HOST'].'/~babyblingbows/');
...
define('DB_DRIVER', 'mysqli');
define('DB_HOSTNAME', 'localhost');
define('DB_USERNAME', 'babyblin_oc1564');
define('DB_PASSWORD', '6JQQ7DJ7[q;t');
define('DB_DATABASE', 'babyblin_oc1564');
define('DB_PREFIX', 'oc_');
}
